    ...
    if ($_POST['HAMAMATSU'] == "Submit for Hamamatsu") {
        ...
        if ($leadExcel == "true") {
            ...
            if ($filesize > 2881064151) {
                echo "<script>alert('Sorry, the file you uploaded exceeds the specified size !!NOT beyond 2M!');location.href='" . $_SERVER["HTTP_REFERER"] . "#Hamamatsu-Origin-Data-Statistics' </script>";
            } elseif ($filesize == 0) {
