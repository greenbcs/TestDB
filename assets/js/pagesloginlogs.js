...
function getData(page)
{
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            var table_html = "";
            table_html += "<table class=\"am-table am-table-striped am-table-hover table-main\"><tr><th width=\"10\">NO</th><th width=\"60\">Username</th><th width=\"60\">Email</th><th width=\"60\">Institution</th><th width=\"60\">LoginIP</th><th width=\"60\">LoginTime</th><th width=\"60\">Status</th></tr>";
            var list = json.list;
            $.each(list, function (index, array) { //遍历json数据列
                ...
                table_html += "<tr><td>" + title_sub + "</td><td>" + array['Username'] + "</td><td>" + array['Email'] + "</td><td>" + array['Institution'] + "</td><td>" + array['LoginIP'] + "</td><td>" + array['LoginTime'] + "</td><td>" + array['Status'] + "</td><tr>";
