...
function getData(page)
{
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                var table_html = "";
                table_html += "<table class=\"am-table am-table-striped am-table-hover table-main\"><tr><th width=\"10\">NO</th><th width=\"60\">Username</th><th width=\"60\">Email</th><th width=\"60\">Institution</th><th width=\"60\">Level</th><th width=\"60\">RegisterIP</th><th width=\"60\">RegisterTime</th><th width=\"60\">Operation Choose</th></tr>";
                var list = json.list;
                $.each(list, function (index, array) { //遍历json数据列
                    ...
                    table_html += "<tr><td>" + title_sub + "</td><td>" + array['Username'] + "</td><td>" + array['Email'] + "</td><td>" + array['Unit'] + "</td><td>" + array['Level'] + "</td><td>" + array['RegisterIP'] + "</td><td>" + array['RegisterTime'] + "</td><td><a class=\"am-icon-edit\" class=\"am-btn-primary am-btn-xs\" href=\"#\" onclick=\"getRowValue(this)\";>  Modify  </a><a class=\"am-icon-trash\" class=\"am-btn-primary am-btn-xs\" href=\"#\" onclick=\"{if(confirm('Delete!?')){window.location.href='backend/delete_pmtuser.php?pmtuser="+array['Username']+"';}else return false;}\">  Delete  </a></td><tr>";
...
function plusorder()
{
    var url="addusers.html"; //转向网页的地址;
    var name="Add Users"; //网页名称，可为空;
...
function getRowValue(element){
    ...
    window.open ("modifyusers.html"+"?"+a+"?"+b+"?"+c+"?"+d+"?"+f, "newwindow", "height=580, width=400, top=50%, left=50%, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no")
    //alert(a);
